...
class Interfaz1:
    def __init__(self):
        group_name = rospy.get_param('/moveit_kr6/Planning_Group')
        self.events = ie.Events1(group_name)
    ...
    def spawn_tools(self):  #--------tools: Title, Clear, get_pos.
        ...
        self.button_get_pos.grid(row=self.start_row_tools+1,column=self.start_column_tools+2, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)
    ...
    def movement(self):
        ...
        self.button_pos1 = tkinter.Button(self.ventana, text= "POS 1", command=lambda: self.events.general("pos1")) 
        self.button_pos2 = tkinter.Button(self.ventana, text= "POS 2", command=lambda: self.events.general("pos2")) 
        self.button_pos3 = tkinter.Button(self.ventana, text= "POS 3", command=lambda: self.events.general("pos3")) 
        self.button_pos4 = tkinter.Button(self.ventana, text= "POS 4", command=lambda: self.events.general("pos4")) 
        self.button_pos5 = tkinter.Button(self.ventana, text= "POS 5", command=lambda: self.events.general("pos5")) 
        #------------------------ Mundo | Ejes
        Options4 = ["Ejes","Mundo"]
    ...
    def spawn_movement(self):
        ...
        self.home_button.grid(row=start_row+2,column=start_column+3, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)
        self.button_pos1.grid(row=start_row+3,column=start_column+3, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)
        self.button_pos2.grid(row=start_row+4,column=start_column+3, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)
        self.button_pos3.grid(row=start_row+5,column=start_column+3, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)
        self.button_pos4.grid(row=start_row+6,column=start_column+3, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)
        self.button_pos5.grid(row=start_row+7,column=start_column+3, columnspan=1, padx=self.matrix_X, pady=self.matrix_Y)
        #------------------------ + | - 
        start_row = 2
        start_column = 1
